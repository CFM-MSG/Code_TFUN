...
def get_parser():
    ...
    parser.add_argument('--snapshots', default='/mnt/disk1/sunjialiang/snapshots/',type=str)
    parser.add_argument('--log', default='log/',type=str)
    parser.add_argument('--model', default='sigmoid',type=str)
    parser.add_argument('--neg', default='semi',type=str)
    ...
    parser.add_argument('--hOut', default=1, type=int)
    parser.add_argument('--numHid', default=1024, type=int)
    parser.add_argument('--rank', default=32, type=int)
    parser.add_argument('--glimpse', default=1, type=int)
    ...
    parser.add_argument('--dataset', default = '/mnt/disk/sunjialiang/recipe1m/', type=str)
